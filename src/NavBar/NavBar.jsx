    ...
    <>
      <nav className='flex justify-end py-10 text-lg font-medium tracking-widest'>
        ...
        <button 
          ...
          <span 
            className={`block bg-black dark:bg-white my-2 rounded-md h-[3px] w-[28px]  ${showMenu? 'transform rotate-45 origin-top-left translate-y-[5px] translate-x-[8px] transition-transform ease-in-out duration-500' : 'rotate-0 transition-transform ease duration-500'}`}
          ></span>
          <span 
            className={`block bg-black dark:bg-white my-[9px] rounded-md h-[3px] w-[28px] ${showMenu? 'opacity-0 transition-opacity' : 'opacity-100 transition-opacity duration-300'}`}
          ></span>
          <span 
